...
const NSString * fragment_Shader6  =
...
- (void)setupProgram {
    GLuint vertexShader = [self loadShaderType:GL_VERTEX_SHADER fileName:vertex_Shader6];
    GLuint fragmentShader = [self loadShaderType:GL_FRAGMENT_SHADER fileName:fragment_Shader6];
