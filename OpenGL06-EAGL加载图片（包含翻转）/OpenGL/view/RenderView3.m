...
- (void)setupProgram {
    GLuint vertexShader = [self loadShaderType:GL_VERTEX_SHADER fileName:vertexShader3];
    GLuint fragmentShader = [self loadShaderType:GL_FRAGMENT_SHADER fileName:fragmentShader3];
