...
- (void)setupBuffers
{
	...
	glVertexAttribPointer(GLKVertexAttribPosition, 2, GL_FLOAT, GL_FALSE, 2 * sizeof(GLfloat), 0);
...
//        NSLog(@"id %d", CVOpenGLESTextureGetName(_chromaTexture));
	...
	GLfloat quadVertexData [] = {
		-1 * normalizedSamplingSize.width, -1 * normalizedSamplingSize.height,  //左下
			 normalizedSamplingSize.width, -1 * normalizedSamplingSize.height,  //右下
		-1 * normalizedSamplingSize.width, normalizedSamplingSize.height,       //左上
			 normalizedSamplingSize.width, normalizedSamplingSize.height,       //右上
	};
