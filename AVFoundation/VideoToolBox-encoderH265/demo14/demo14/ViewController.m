...
@property (nonatomic, assign) FILE *h265_file;
...
#pragma mark - VideoEncoder Delegate
...
-(FILE *)h265_file {
    if (!_h265_file) {
        ...
        NSString *fileName =  [self.fileManager createRandomMediaTypeName:MEDIA_TYPE_H265];
        NSString *filePath = [self.fileManager createFileWithFileName:fileName];
        const char *h265File = filePath.UTF8String;
        FILE *h265_file = fopen(h265File, "wb");
        _h265_file = h265_file;
