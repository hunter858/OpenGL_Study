...
- (void)updateTextureParameters{
    ...
    glTexParameterf(self.baseEffect.texture2d0.target, GL_TEXTURE_WRAP_S, (self.shouldRepeatTexture) ? GL_MIRRORED_REPEAT : GL_CLAMP_TO_EDGE);
    ///设置拉伸采样模式
    ///，GL_NEAREST 最近临近值，获取最靠近纹理坐标的像素
    /// GL_LINEAR 线性插值过滤，获取坐标点附件4个像素的加权平均值
