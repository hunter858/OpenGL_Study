...
#import "KYLCameraHandler.h"
#import "KYLCameraModel.h"

@interface KYLCameraHandler ()<AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
...
@implementation KYLCameraHandler
...
- (void)configureCameraWithModel:(KYLCameraModel *)model {
    ...
    AVCaptureDevice *device = [KYLCameraHandler getCaptureDevicePosition:model.position];
    
    // Set frame rate and resolution
    [KYLCameraHandler setCameraFrameRateAndResolutionWithFrameRate:model.frameRate
...
- (void)captureOutput:(AVCaptureOutput *)output didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection {
    ...
    if ([self.delegate respondsToSelector:@selector(KYLCaptureOutput:didOutputSampleBuffer:fromConnection:)]) {
        [self.delegate KYLCaptureOutput:output didOutputSampleBuffer:sampleBuffer fromConnection:connection];
    }
}
